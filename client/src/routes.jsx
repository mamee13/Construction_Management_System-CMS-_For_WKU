...
// In the getDashboardPathByRole function, update the consultant path:
const getDashboardPathByRole = (role) => {
  switch (role) {
    case 'admin':
      return '/dashboard';
    case 'consultant':
      return '/consultant-dashboard'; // Updated path
    case 'contractor':
    ...
    <Router>
      ...
      <Routes>
        ...
        >
          ...
          {/* Add these two routes here, inside the MainLayout route */}
          <Route
