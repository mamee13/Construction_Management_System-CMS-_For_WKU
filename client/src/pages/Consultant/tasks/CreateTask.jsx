  ...
  return (
    <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
      ...
      <div className="sm:flex sm:items-center sm:justify-between mb-6 pb-4 border-b border-gray-200">
        ...
        <button type="button" onClick={() => navigate("/consultant/tasks")} /* ... Back button styles ... */ >
            ...
            return (
              <Form>
                <div className="px-4 py-5 sm:p-6 space-y-6">
                  <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-6"> {/* Task Name */}
                        ...
                        <Field type="text" name="taskName" id="taskName" className={`mt-1 block w-full border ${errors.taskName && touched.taskName ? 'border-red-500':'border-gray-300'} ...`} />
                    ...
                    <div className="sm:col-span-6"> {/* Description */}
                        ...
                        <Field as="textarea" name="taskDescription" id="taskDescription" rows={4} className={`mt-1 block w-full border ${errors.taskDescription && touched.taskDescription ? 'border-red-500':'border-gray-300'} ...`} />
                    ...
                    <div className="sm:col-span-6">
                      ...
                      <Field
                        ...
                        // onChange={(e) => { // Handled by useEffect now
                        //   const newProjectId = e.target.value;
                        //   setFieldValue('project', newProjectId); // Update Formik state
                        // }}
                      >
                    ...
                    {/* Start Date, End Date - Unchanged */}
                     <div className="sm:col-span-3"> {/* Start Date */}
                        ...
                        <Field type="date" name="startDate" id="startDate" className={`mt-1 block w-full border ${errors.startDate && touched.startDate ? 'border-red-500':'border-gray-300'} ...`} />
                     ...
                     <div className="sm:col-span-3"> {/* End Date */}
                        ...
                        <Field type="date" name="endDate" id="endDate" className={`mt-1 block w-full border ${errors.endDate && touched.endDate ? 'border-red-500':'border-gray-300'} ...`} />
                    ...
                    <div className="sm:col-span-6">
                     ...
                     <div className="sm:col-span-3"> {/* Status */}
                        ...
                        <Field as="select" name="status" id="status" className={`mt-1 block w-full border ${errors.status && touched.status ? 'border-red-500':'border-gray-300'} ...`} >
                      ...
                      <div className="sm:col-span-3"> {/* Priority */}
                         ...
                         <Field as="select" name="priority" id="priority" className={`mt-1 block w-full border ${errors.priority && touched.priority ? 'border-red-500':'border-gray-300'} ...`} >
                ...
                <div className="px-4 py-3 bg-gray-50 text-right sm:px-6 rounded-b-lg">
                  <button type="button" onClick={() => navigate("/consultant/tasks")} /* ... cancel button styles ... */
                  ...
                  <button
                    ...
                    className={`inline-flex justify-center items-center py-2 px-4 border ... ${
