    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        {statCards.map((card) => (
          <div 
            key={card.name} 
            className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 mx-auto w-full max-w-md"
          >
