...
// //   // Added Schedules navigation item below connects schedules related pages
...
//      // Also handles case where currentUser might be briefly null after logout but before redirect
//     if (!authAPI.isAuthenticated() || !authAPI.isAdmin()) {
//          // Check isAuthenticated first to handle logout scenarios
//         if (!authAPI.isAuthenticated() && !localStorage.getItem("token")) { // Extra check for token absence after logout
//              useEffect(() => { navigate("/login"); }, [navigate]);
//         }
//         return null; // Or <LoadingSpinner />;
//     }

//     // Ensure currentUser is available before rendering user-specific info
//     if (!currentUser) {
//         // This might happen briefly if auth state updates async
